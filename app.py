...
#    BOOTSTRAP_SERVERS = get_kafka_bootstriap('mskbootstriapbrokers')
    ...
    ordermanager5 = OrderManager()
    ordermanager6 = OrderManager()
    ordermanager7 = OrderManager()
    ordermanager8 = OrderManager()
    ...
    ordermanager5.register_kafka_listener('orderkafka')
